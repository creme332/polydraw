...
public class GettingStartedTutorial extends TutorialPanel {
    ...
    public GettingStartedTutorial() throws InvalidPathException, InvalidIconSizeException {
        ...
        // Add Introduction
        JLabel introLabel = new JLabel("<html><h1>Getting Started Tutorial</h1><p>Welcome to the application! This tutorial will guide you through the various components and features of the interface to help you get started.</p></html>");
